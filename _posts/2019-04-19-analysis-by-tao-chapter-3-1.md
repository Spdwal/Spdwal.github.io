...
$\Rightarrow \forall x \in A \cup B \Rightarrow x \in A \or x \in B \Rightarrow x \in B$ 

$\therefore A \subseteq B \Rightarrow A \cup B = B$  。

再证命题1蕴含命题3:

$A \subseteq B \Rightarrow \forall x \in A, x \in B \and x \in A \Rightarrow x \in A$
...
6. 先证明 $A \cap (B \cup C) = (A \cap B) \cup (A \cap C)$
   ...
   $\forall x \in A \cap (B \cup C) \Rightarrow x \in A \and x \in (B \cup C)$

   可分成以下两种情况：

   1. $x \in A \and x \in B \Rightarrow x \in (A \cap B) \Rightarrow x \in (A \cap B) \cup (A \cap C)$
   2. $x \in A \and x \notin B \and x \in c \Rightarrow x \in (A \cap C) \Rightarrow x \in (A \cap B) \cup (A \cap C)$
   ...
   $\forall x \in A \cup (B \cap C) \Rightarrow x \in A \or x \in (B \cap C)$

   也分为两种情况：

   1. $x \in A \Rightarrow  x \in (A \cap B) \and x \in (A \cap C) \Rightarrow x \in (A \cap B) \cup (A \cap C)$
   2. $x \in (B \cap C) \Rightarrow x \in B \and x \in C \Rightarrow x \in (A \cup B) \and x \in (A \cup C) \Rightarrow x \in (A \cup B) \cap (A \cup C)$
   ...
   2. $x \notin A \and x \in (B \cap C) \Rightarrow x \in A \cup (B \cap C)$

   $\therefore \forall x \in (A \cup B) \cap (A \cup C) \subseteq A \cup (B \cap C)$

   $\therefore A \cup (B \cap C) = (A \cup B) \cap (A \cup C)$ 得证。

7. $\forall x \in (X \setminus A) \Rightarrow \forall x \in X \and x \notin A$

   $A \cup (X \setminus A) \Rightarrow \forall x \in A \or \forall x \in (X \setminus A) $ 又 $\because A \subseteq X \Rightarrow \in X$
   ...
   $A \cap (X \setminus A) \Rightarrow \forall x \in A \and (x \in X \and x \notin A) \Rightarrow (x \in A \and x \notin A) \and x \in X$

   $x \in \phi \and x \in X \Rightarrow x \in \phi$
...
8. 先证 $X \setminus (A \cup B) = (X \setminus A) \cap (X \setminus B)$
   ...
   $x \in X \setminus A \and x \in X \setminus B$

   $x \in (X \setminus A) \cap (x \setminus B)$

   $X \setminus (A \cup B) \subseteq (X \setminus A) \cup (X \setminus B)$

   $\forall x \in (X \setminus A) \cap (X \setminus B) \Rightarrow x \in X \and x \notin A \and x \notin B$
   ...
   $X \setminus (A \cap B) \Rightarrow \forall x \in X \and x \notin (A \cap B)$
...
$\forall x \in A \cap B \Rightarrow x \in A \and x \in B \Rightarrow x \in A \Rightarrow A \cap B \subseteq A$

同理可证 $A \cap B \subseteq B$

$C \subseteq A \and C \subseteq B \Rightarrow \forall x \in C, x \in A \and x \in B \Rightarrow x \in A \cap B$

$\therefore C \subseteq  A \cap B$

$C \subseteq A \cap B \Rightarrow \forall x \in C, x \in A \and x \in B \Rightarrow C \subseteq A \and C \subseteq B$ 

$\therefore C \subseteq A \and C \subseteq B \Leftrightarrow C \subseteq A \cap B$ 得证。
...
$\forall x \in A \cup B \and x \in A \because A \subseteq A \cup B \therefore x \in A \therefore A \cap (A \cup B) \subseteq A$

$\forall x \in A, x \in A \and x \in (A \cup B) \therefore x \in A \cap (A \cup B)$
...
$\forall x \in X \setminus B \Rightarrow x \in X \and x \notin B$
...
$y \in \{x \in A: Q(x) \ is \ true \} \Leftrightarrow y \in A \and Q(y) \ is \ true$ 得证。
